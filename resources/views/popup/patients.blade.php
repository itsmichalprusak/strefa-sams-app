        ...
        <div class="modal-body">
            <form method="POST" action="{{Route('UsersPatientsEdit')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="name" name="Name" id="imie" aria-describedby="firstname" placeholder="Imię Pacjenta" class="form-control" value="{{$user->Name}}">
                    <small id="firstname" class="form-text text-muted">Podaj imię pacjenta, którego chcesz dodać do bazy.</small>
                </div>
                <div class="form-group">
                    <label for="nazwisko">Nazwisko</label>
                    <input type="name" name="Surname" id="nazwisko" aria-describedby="nazwisko" placeholder="Nazwisko Pacjenta" class="form-control" value="{{$user->Surname}}">
                ...
                <div class="form-group">
                    ...
                    <input type="name" name="Email" id="Email" placeholder="Nick Discord" aria-describedby="Email" class="form-control" value="{{$user->Email}}">
                    <small id="Email" class="form-text text-muted">Podaj nick na Discord'dzie pacjenta, którego chcesz dodać do bazy.</small>
                </div>
                <div class="form-group">
                    <label for="PhoneNumber">Numer telefonu</label>
                    <input type="text" id="PhoneNumber" name="PhoneNumber" placeholder="Numer Telefonu" aria-describedby="PhoneNumber" class="form-control" value="{{$user->PhoneNumber}}">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control" id="dataurodzenia" onfocus="(this.type='date')" value="{{$user->BirthDate}}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="Comments" class="form-control" id="Comments" aria-describedby="Comments" placeholder="Choroby, Leki, Leczenia">{{$user->Comments}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="BloodGroup" class="form-control" id="BloodGroup" aria-describedby="BloodGroup">
