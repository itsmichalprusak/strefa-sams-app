...
@section('body')
    ...
    <form method="POST" action="{{route('addpatient')}}">
        ...
        <div class="form-group">
            ...
            <input type="name" name="Email" id="Email" placeholder="Nick Discord" aria-describedby="Email" class="form-control">
            <small id="Email" class="form-text text-muted">Podaj nick na Discord'dzie pacjenta, którego chcesz dodać do bazy.</small>
        </div>
        <div class="form-group">
            <label for="PhoneNumber">Numer telefonu</label>
            <input type="text" id="PhoneNumber" name="PhoneNumber" placeholder="Numer Telefonu" aria-describedby="PhoneNumber" class="form-control">
        ...
        <div class="form-group">
            ...
            <textarea name="Comments" class="form-control" id="Comments" aria-describedby="Comments" placeholder="Choroby, Leki, Leczenia"></textarea>
